...
$(document).ready(function () {
    $("ul.ul_option li").click(function () {
        $("ul.ul_option li").removeClass("active");
        $(this).addClass("active");


        var idColor = $(this).attr("rel");
        $('#hidColor').val(idColor);
    });

    $("ul.ul_option_size li").click(function () {
        $("ul.ul_option_size li").removeClass("active");
        $(this).addClass("active");


        var idSize = $(this).attr("rel");
        $('#hidSize').val(idSize);
    });


    //Them sp vao gio hang - btn Mua ngay
    $('#btnAddCart_New').click(function () {
        alert("PHÚC");
